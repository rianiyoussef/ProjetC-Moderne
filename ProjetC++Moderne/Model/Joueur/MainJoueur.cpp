...
int MainJoueur::trouverCarte(const std::string& valeur, const std::string& symbole) const
{
    for (int i = 0; i < cartes.size(); i++)
    {
...
bool MainJoueur::possedeAutreQueSymbole(const std::string& symbole) const
{
    for (int i = 0; i < cartes.size(); i++)
    {
        if (cartes[i]->getSymbole() != symbole)
...
bool MainJoueur::possedeCarteAutreQue(const std::string& valeur,
    const std::string& symbole) const
{
    for (int i = 0; i < cartes.size(); i++)
    {
        if (!(cartes[i]->getValeur() == valeur &&
